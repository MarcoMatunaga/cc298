...
!         E_barra(i,j,4) = ( (Q_barra(i,j,4)/metric_jacobian(i,j)) + p(i,j) )*( U_contravariant(i,j))
!     end do 
! end do
! !
...
!         F_barra(i,j,4) = ( (Q_barra(i,j,4)/metric_jacobian(i,j)) + p(i,j) )*( V_contravariant(i,j))
!     end do         
! end do 
!
!
